...
class CountersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create counter" do
    assert_difference("Counter.count") do
      post counters_url, params: { counter: { count: @counter.count, name: @counter.name, style: @counter.style } }
    end
  ...
  test "should update counter" do
    patch counter_url(@counter), params: { counter: { count: @counter.count, name: @counter.name, style: @counter.style } }
